...
1. [[file:tetris/index.html][An NES tetris clone that I made for my Computer Graphics class.]]
...
2. [[https://github.com/jsalzbergedu/pegreg][PEGREG]]
...
3. [[https://gitlab.com/rosie-pattern-language/rosie/-/tree/lint1][Rosie Lint Library]] 
